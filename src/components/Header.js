                ...
                <div className='flex items-center justify-between h-20'>
                    ...
                    <nav className='hidden md:flex items-center gap-8'>
                        {navItems.map((item) => (
                            <button
                                ...
                                className={`${isScrolled ? 'text-foreground' : 'text-[#f5f5f5]'} hover:text-secondary transition-colors duration-300 font-medium relative group`}
                            >
                                {t.nav[item.key]}
                    ...
                    <div className='flex items-center gap-4'>
                        ...
                        >
                            <Globe
                                className='w-4 h-4'
                                color={!isScrolled ? '#f5f5f5' : 'black'}
                            />
                            <span
                                className={`font-medium ${!isScrolled ? 'text-[#f5f5f5]' : 'text-foreground'}`}
                            >
                                {language === 'he' ? 'EN' : 'עב'}
                            </span>
                        </Button>
