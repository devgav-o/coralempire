        ...
        <div className="animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
            <Button
              ...
              className="bg-[#25D366] hover:bg-[#128C7E] text-white rounded-full px-8 py-6 text-lg font-medium flex items-center gap-3 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
            >
